...
//             • Worked on a project to analyze and visualize Leads outcomes for Brokerage by removing null and void records using Zoho
//             Dataprep which enhanced customer relations by 20%
//             • Executed and integrated Data Cleaning and structuring using custom SQL queries in Zoho Analytics on company's data
//             • Visualized CRM to extract property data, using Python and Deluge Scripting to automate new leads into the property database
//           </p>
//         </VerticalTimelineElement>
//         <VerticalTimelineElement
//     className="vertical-timeline-element--work"
